...
// Verificar que BASE_PATH está definido
if (!defined('BASE_PATH')) {
    die('BASE_PATH no está definido');
}
?>
          ...
          <div class="card my-5 mx-3">
            ...
            <form action="" method="POST">
              ...
              <div class="d-grid mt-4">
                ...
                <button type="submit" class="btn btn-primary"><a href="<?= BASE_PATH ?>/views/home.php">Loggin</a></button>
              </div>
